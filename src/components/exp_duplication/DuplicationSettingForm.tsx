...
export interface DuplicationSettingType {
  username: string;
  password: string;
}

interface DuplicationSettingsFormProps {
  onStart: (data: DuplicationSettingType) => void;
  isOpen: boolean;
  onClose: () => void;
}

const initialFormData: DuplicationSettingType = {
  username: "",
  password: "",
};

const DuplicationSettingForm: React.FC<DuplicationSettingsFormProps> = ({
  onStart,
  isOpen,
  onClose,
}) => {
  const [formData, setFormData] =
    useState<DuplicationSettingType>(initialFormData);
...
export default DuplicationSettingForm;
