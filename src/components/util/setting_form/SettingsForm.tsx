...
interface SettingsFormProps {
  onStart: (data: SettingData) => void;
  isOpen: boolean;
  onClose: () => void;
}

const initialFormData: SettingData = {
  username: "",
  password: "",
  folder: "",
};
...
const SettingsForm: React.FC<SettingsFormProps> = ({
  ...
  const [formData, setFormData] = useState<SettingData>(initialFormData);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // VALIDATION
    if (!formData.username || !formData.password || !formData.folder) {
