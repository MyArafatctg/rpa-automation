...
import EInvoiceHandM from "../components/e_invoiceing/EInvoiceHandM";
...
const EInvoicingHAndM = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const apiUrl = `${BACKEND_URL}/invoice?userId=${storedClientId}`;
      try {
          ...
          {activeTab === "internal" && (
            <div className="overflow-x-auto">
              <div className="flex justify-center">
                <EInvoiceHandM data={dbData} fileName={"internalSource"} />
              </div>
            </div>
          )}
            ...
            <div className="overflow-x-auto">
              {(excelData.length > 0 && (
                <>
                  ...
                  <div className="flex justify-center">
                    <EInvoiceHandM data={excelData} fileName={fileName} />
                  </div>
                </>
              )) || (
